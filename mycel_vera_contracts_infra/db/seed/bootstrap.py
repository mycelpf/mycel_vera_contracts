...
PERMISSIONS = [
    ...
    ("read", "archive", "Read archive records"),
    ("write", "archive", "Create/update/delete archive records"),
    ("read", "compliance", "Read compliance records"),
    ("write", "compliance", "Create/update/delete compliance records"),
    ("read", "coverage", "Read coverage records"),
    ("write", "coverage", "Create/update/delete coverage records"),
    ("read", "job", "Read job records"),
    ("write", "job", "Create/update/delete job records"),
    ("read", "oos_conflicts", "Read oos conflicts records"),
    ("write", "oos_conflicts", "Create/update/delete oos conflicts records"),
    ("read", "policy", "Read policy records"),
    ("write", "policy", "Create/update/delete policy records"),
    ("read", "reinsurance", "Read reinsurance records"),
    ("write", "reinsurance", "Create/update/delete reinsurance records"),
    ("read", "risk_units", "Read risk units records"),
    ("write", "risk_units", "Create/update/delete risk units records"),
    ("read", "transactions", "Read transactions records"),
    ("write", "transactions", "Create/update/delete transactions records"),
]

ROLES = {
    "mycel_vera_contracts_reader": {
        "description": "Read-only access to mycel_vera_contracts data",
        "filter": lambda a, r: a == "read",
    },
    "mycel_vera_contracts_writer": {
        "description": "Full CRUD access to mycel_vera_contracts data",
...
async def seed_rbac():
    ...
    print(f"  RBAC seed complete for mycel_vera_contracts")


if __name__ == "__main__":
    print(f"\n=== RBAC Bootstrap: mycel_vera_contracts ===")
